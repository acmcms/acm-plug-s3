...
class ChangeForEntryNested extends ChangeAbstract implements ChangeNested {
	...
	ChangeForEntryNested(final List<ChangeNested> target, final StorageLevel3 storage, final EntryImpl entry) {
	...
	private String toStringDetails() {
		...
		return "guid=" + this.entry.getGuid() + ", parentGuid=" + this.parentGuid + buffer;
	}
