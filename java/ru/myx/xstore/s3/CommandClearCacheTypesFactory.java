 ...
 */
/** @author myx */
public final class CommandClearCacheTypesFactory implements ObjectFactory<Object, ControlContainer<?>> {
	...
	static final class CreateContainer extends AbstractContainer<CreateContainer> {
		...
		public Object getCommandResult(final ControlCommand<?> command, final BaseObject arguments) {

			{
				...
				;
				this.parent.getServer().logQuickTaskUsage("XDS_COMMAND_STORAGE(3)_CT", result);
			}
