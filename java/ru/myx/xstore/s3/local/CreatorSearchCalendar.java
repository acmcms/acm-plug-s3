...
final class CreatorSearchCalendar implements
		CreationHandlerObject<RequestSearchCalendar, Map<Integer, Map<Integer, Map<String, Number>>>> {
	...
	@Override
	public final Map<Integer, Map<Integer, Map<String, Number>>> create(
			final RequestSearchCalendar attachment,
			final String key) {
		try {
	...
	final Map<Integer, Map<Integer, Map<String, Number>>> search(
		...
		final RequestSearchCalendar attachment = new RequestSearchCalendar( this.parent.getFinder(),
				lnkId,
				all,
				timeout,
				dateStart,
				dateEnd,
				filter );
		Report.info( "STRLCL", "MISS-SEARCH-CALENDAR: "
				+ lnkId
				+ ", "
				+ all
				+ ", "
				...
				+ ", "
				+ filter );
		final Map<Integer, Map<Integer, Map<String, Number>>> check2 = cacheTree
				.get( lnkId, key, attachment, key, this );
