...
final class CreatorSearch implements CreationHandlerObject<RequestSearch, Map.Entry<String, Object>[]> {
	...
	final Map.Entry<String, Object>[] search(final CacheL2<Object> cacheTree,
		...
		final RequestSearch attachment = new RequestSearch(this.parent.getFinder(), lnkId, limit, all, timeout, sort, dateStart, dateEnd, filter);
		Report.info("STRLCL", "MISS-SEARCH: " + lnkId + ", " + limit + ", " + all + ", " + timeout + ", " + sort + ", " + dateStart + ", " + dateEnd + ", " + filter);
